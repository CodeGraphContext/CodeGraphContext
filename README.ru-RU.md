...
| **Требования**| `pip install real_ladybug` | `pip install falkordblite` | Сервер Neo4j / Docker |
...
2.  **Настройка базы данных (Автоматически)**
    ...
    - **KùzuDB (По умолчанию):** Работает нативно на Windows, macOS и Linux без дополнительной настройки. Просто выполните `pip install real_ladybug` — и всё готово!
